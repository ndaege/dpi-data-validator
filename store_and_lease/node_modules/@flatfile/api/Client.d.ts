...
import { Accounts } from "@flatfile/api/api/resources/accounts/client/Client";
import { Agents } from "@flatfile/api/api/resources/agents/client/Client";
import { Apps } from "@flatfile/api/api/resources/apps/client/Client";
import { Assistant } from "@flatfile/api/api/resources/assistant/client/Client";
...
import { Commits } from "@flatfile/api/api/resources/commits/client/Client";
import { DataRetentionPolicies } from "@flatfile/api/api/resources/dataRetentionPolicies/client/Client";
import { Documents } from "@flatfile/api/api/resources/documents/client/Client";
import { Entitlements } from "@flatfile/api/api/resources/entitlements/client/Client";
...
import { Foreigndb } from "@flatfile/api/api/resources/foreigndb/client/Client";
...
import { Mapping } from "@flatfile/api/api/resources/mapping/client/Client";
import { Records } from "@flatfile/api/api/resources/records/client/Client";
import { Roles } from "@flatfile/api/api/resources/roles/client/Client";
import { Secrets } from "@flatfile/api/api/resources/secrets/client/Client";
import { Sheets } from "@flatfile/api/api/resources/sheets/client/Client";
import { Snapshots } from "@flatfile/api/api/resources/snapshots/client/Client";
...
import { Views } from "@flatfile/api/api/resources/views/client/Client";
...
export declare class FlatfileClient {
    protected readonly _options: FlatfileClient.Options;
    constructor(_options?: FlatfileClient.Options);
    ...
    get dataRetentionPolicies(): DataRetentionPolicies;
