import { Flatfile } from "@flatfile/plugin-export-workbook/node_modules/@flatfile/api";
 ...
 */
export const exportWorkbookPlugin: (opts?: PluginOptions) => (listener: FlatfileListener) => void;
