...
export declare namespace Event {
    type Raw = Event.AgentCreated | Event.AgentUpdated | Event.AgentDeleted | Event.SpaceCreated | Event.SpaceUpdated | Event.SpaceDeleted | Event.SpaceArchived | Event.SpaceExpired | Event.SpaceGuestAdded | Event.SpaceGuestRemoved | Event.DocumentCreated | Event.DocumentUpdated | Event.DocumentDeleted | Event.WorkbookCreated | Event.WorkbookUpdated | Event.WorkbookDeleted | Event.WorkbookExpired | Event.SheetCreated | Event.SheetUpdated | Event.SheetDeleted | Event.SheetCountsUpdated | Event.SnapshotCreated | Event.RecordsCreated | Event.RecordsUpdated | Event.RecordsDeleted | Event.FileCreated | Event.FileUpdated | Event.FileDeleted | Event.FileExpired | Event.JobCreated | Event.JobUpdated | Event.JobDeleted | Event.JobFailed | Event.JobCompleted | Event.JobReady | Event.JobScheduled | Event.JobOutcomeAcknowledged | Event.JobPartsCompleted | Event.ProgramCreated | Event.ProgramUpdated | Event.CommitCreated | Event.CommitUpdated | Event.CommitCompleted | Event.SecretCreated | Event.SecretUpdated | Event.SecretDeleted | Event.LayerCreated | Event.EnvironmentCreated | Event.EnvironmentUpdated | Event.EnvironmentDeleted;
