...
declare class FlatfileEvent extends AuthenticatedClient {
    ...
    update(records: RecordsWithLinks, compressRequestBody?: boolean): Promise<void>;
    /**
...
type EventCallback = (evt: FlatfileEvent) => void | Promise<void>;
...
export { type Arrayable, AuthenticatedClient, Browser, Client, type EventCallback, EventDriver, type EventFilter, EventHandler, FlatfileEvent, FlatfileListener, FlatfileVirtualMachine, type Listener, FlatfileListener as default };
